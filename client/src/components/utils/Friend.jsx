  ...
  return (
    <Stack direction={'row'} gap={2} p={2} alignItems={'center'}>
        ...
        <Stack direction={'column'} sx={{width: "80%"}}>
            ...
            <Typography display={{xs:'none',md:'none', lg:'block'}} variant='p'>{moment(createdAt).format('Do MMM YY, LT')}</Typography>
            <Typography display={{xs:'none',sm:'none', md:'block', lg:'none'}} variant='p'>{moment(createdAt).format('DD/MM/YY, LT')}</Typography>
            <Typography display={{xs:'block', md:'none', lg:'none'}} variant='p'>{moment(createdAt).format('DD/MM, LT')}</Typography>
        </Stack>
        {friendId !== user._id ? (
